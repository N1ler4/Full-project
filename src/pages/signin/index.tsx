  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="mt-5">
        ...
        Hisobingiz yo‘qmi?? <span onClick={moveToSignUp} className="text-blue-400 cursor-pointer">Ro'yxatdan o'tish</span>
        </p>
      </div>
      <div>
        <p className="text-center text-[14px]">
        Parolni unutdingiz? <span onClick={restorePassword} className="text-blue-400 cursor-pointer">Parolni tiklash</span>
        </p>
      </div>
    </div>
  );
